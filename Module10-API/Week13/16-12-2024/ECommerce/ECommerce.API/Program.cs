...
/*
 * 
 * Book adýnda bir Entity oluþturun. (Base entityden miras alsýn, ayrýca Name, Author, PageCount bilgileri olsun.)
 * Gerekli DTO'larý oluþturun.
 * Gerekli Service classýný oluþturun.
 * Gerekli Controller'ý oluþturun. 
