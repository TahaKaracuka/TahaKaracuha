...
namespace ECommerce.Business.Concrete
{
    public class RoleService : IRoleService
    {
        ...
        public async Task SeedRolesAsync()
        {
            ...
            {
                var adminRole = new ApplicationRole { Name = "AdminUser", Description = "Sistem üzerinde tüm haklara sahip kullanıcılar için tanımlanan rol", NormalizedName = "ADMINUSER" };
